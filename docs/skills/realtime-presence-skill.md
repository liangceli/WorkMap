...
Backend exposes latest positions through `GET /virtual-office/map/:officeMapId/positions`.

## Not Confirmed

- No websocket or server-sent events implementation was found.
- No frontend polling of backend virtual-office positions was confirmed.
