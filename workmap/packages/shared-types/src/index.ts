...
export const WORKMAP_DEFAULT_OFFICE_MAP_MANIFEST = {
  ...
  mapVersion: "2026-06-room-zones-v2",
  ...
  rooms: [
    {
      ...
      bounds: { x: 800, y: 800, width: 800, height: 480 },
    },
    {
      ...
      autoStatus: "available",
      bounds: { x: 1632, y: 1376, width: 480, height: 384 },
    },
    {
      key: "focus-room",
      name: "Focus Room",
      type: "FOCUS",
      autoStatus: "focus",
      bounds: { x: 800, y: 1376, width: 384, height: 384 },
    },
    {
      key: "meeting-room",
      ...
      type: "MEETING",
      autoStatus: "busy",
      bounds: { x: 1632, y: 800, width: 768, height: 480 },
    },
    {
      key: "sales-zone",
      name: "Sales Zone",
      type: "DEPARTMENT_ZONE",
      autoStatus: "available",
      bounds: { x: 1184, y: 1376, width: 416, height: 384 },
    },
    {
      key: "break-room",
      name: "Break Room",
      type: "BREAK",
      autoStatus: "break",
      bounds: { x: 2112, y: 1568, width: 288, height: 192 },
    },
  ],
  navigation: [
    {
