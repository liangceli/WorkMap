...
export const integrationItems: IntegrationItem[] = [
  {
    ...
    description: "Open a teammate chat from CandidGrid contact actions.",
  ...
  },
  {
    ...
    href: "mailto:?subject=CandidGrid%20follow-up",
    status: "ready",
    privacyNote: "Uses mailto links. CandidGrid does not read email bodies.",
  },
  {
    id: "calendar",
  ...
  },
  {
    ...
    name: "3CX",
    category: "Calling",
    description: "Open a call action from CandidGrid contact menus.",
    actionLabel: "Open 3CX",
    href: "https://www.3cx.com/user-manual/web-client/",
    status: "needs_setup",
    privacyNote: "Link-based launch only. CandidGrid does not record call audio.",
  },
];
